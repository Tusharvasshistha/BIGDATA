...
public class Q_004CW {
	public static class Q_004CWMapper extends
		...
		public void map(LongWritable key, Text value, Context context)
...

			{
				...
				if (token[1].equals("CERTIFIED-WITHDRAWN")) {
	...
	public static class Q_004CWPartitioner extends Partitioner<Text, LongWritable> {
	...
	public static class Q_004CWReducer extends
...

	{
		...
		job.setJarByClass(Q_004CW.class);
		job.setMapperClass(Q_004CWMapper.class);
		job.setPartitionerClass(Q_004CWPartitioner.class);
		job.setReducerClass(Q_004CWReducer.class);
