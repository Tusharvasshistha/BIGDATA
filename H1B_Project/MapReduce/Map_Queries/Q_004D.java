...
public class Q_004D {
	public static class Q_004DMapper extends
	...
	public static class Q_004DPartitioner extends Partitioner<Text, LongWritable> {
	...
	public static class Q_004DReducer extends
...

	{
		...
		job.setJarByClass(Q_004D.class);
		job.setMapperClass(Q_004DMapper.class);
		job.setPartitionerClass(Q_004DPartitioner.class);
		job.setReducerClass(Q_004DReducer.class);
