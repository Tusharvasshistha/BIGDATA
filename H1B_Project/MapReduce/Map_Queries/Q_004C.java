...
public class Q_004C {
	public static class Q_004_Mapper extends Mapper<LongWritable, Text, Text, LongWritable> {
	...
	public static class Q_004CPartitioner extends Partitioner<Text, LongWritable> {
	...
	public static class Q_004CReducer extends
...

	{
		...
		job.setJarByClass(Q_004C.class);
		job.setMapperClass(Q_004_Mapper.class);
		job.setPartitionerClass(Q_004CPartitioner.class);
		job.setReducerClass(Q_004CReducer.class);
